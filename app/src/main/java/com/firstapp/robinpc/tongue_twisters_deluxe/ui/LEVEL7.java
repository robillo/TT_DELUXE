...
public class LEVEL7 extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        levelSeven = getResources().getStringArray(R.array.seven);
    ...
    public void onClick(View v){
        ...
        switch (v.getId()){
            ...
            case R.id.seven1:{
                tts_index=0;
                autoSpeak(levelSeven[tts_index]);
                alert.setMessage(levelSeven[tts_index]).setIcon(R.drawable.dialog).setTitle("LEVEL 7 TT " + (tts_index+1)).create().show();
                break;
            }
            case R.id.seven2:{
                tts_index=1;
